...
*/
interface ViewportPriorityParsingConfig {
    /**
...
services.
*/
declare function viewportPriorityParsing(config: ViewportPriorityParsingConfig): Extension;
/**
Lezer-style
...
export type { Config, MatchResult, StreamParser, Sublanguage, TagStyle, ViewportPriorityParsingConfig };
