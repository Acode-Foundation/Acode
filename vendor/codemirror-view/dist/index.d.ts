...
*/
interface ViewportBufferConfig {
    /**
...
is already present.
*/
interface ControlledTouchScrollConfig {
    /**
...
declare class EditorView {
    ...
    */
    static viewportBuffer: Facet<ViewportBufferConfig, any>;
    /**
    Configure render-gated vertical touch scrolling on Android Chromium.
    */
    static controlledTouchScroll: Facet<ControlledTouchScrollConfig, any>;
    /**
