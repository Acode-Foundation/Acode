...
public class CrashActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    descView.setText(
      "An unrecoverable exception occurred in Acode's native system. The application details and exception logs have been recorded below."
    );
    ...
    metaCard.addView(
      createMetaRow("App Version", appVersion + " (" + appBuild + ")")
    );
    ...
    TextView btnRestart = createButton(
      "Restart Acode",
      "#ffffff",
      "#4285f4",
      false
