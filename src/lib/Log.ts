...
export class Log {
    ...
    w(message: any, ...args: any[]): void {
        console.warn(`%c${this.format("WARN", message)}`, "color: #ffaa00", ...args);
    }

    e(message: any, ...args: any[]): void {
        console.error(`%c${this.format("ERROR", message)}`, "color: #ff4444", ...args);
    }

    d(message: any, ...args: any[]): void {
        //TODO: Only show debug messages in debug mode
        console.debug(`%c${this.format("DEBUG", message)}`, "color: #999999", ...args);
    }
}
